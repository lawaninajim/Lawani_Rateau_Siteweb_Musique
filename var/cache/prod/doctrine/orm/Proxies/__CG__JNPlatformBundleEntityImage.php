...
namespace Proxies\__CG__\JN\PlatformBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \JN\PlatformBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'JN\\PlatformBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'JN\\PlatformBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'JN\\PlatformBundle\\Entity\\Image' . "\0" . 'alt', 'file', '' . "\0" . 'JN\\PlatformBundle\\Entity\\Image' . "\0" . 'tempFilename'];
        }
